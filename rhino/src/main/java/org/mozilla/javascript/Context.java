...
public class Context implements Closeable {
    ...
    public final Object evaluateReader(
            JSScope scope, Reader in, String sourceName, int lineno, Object securityDomain)
            throws IOException {
    ...
    /**
     * Create a new JavaScript scope. This object will not have a prototype, just a parent scope
     * object.
     */
