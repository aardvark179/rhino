...
final class MemberBox implements Serializable {
    ...
    MemberBox(JSScope scope, Method method, TypeInfoFactory factory) {
        this.scope = scope;
        init(method, factory, method.getDeclaringClass());
    }

    MemberBox(JSScope scope, Constructor<?> constructor, TypeInfoFactory factory) {
        this.scope = scope;
        init(constructor, factory);
    }

    MemberBox(JSScope scope, Method method, TypeInfoFactory factory, Class<?> parent) {
        this.scope = scope;
