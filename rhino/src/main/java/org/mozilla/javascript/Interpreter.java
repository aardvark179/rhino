...
public final class Interpreter implements Evaluator {
    ...
    private static class CallFrame extends ACallFrame implements Cloneable, Serializable {
    ...
    public void captureStackInfo(RhinoException ex) {
        ...
        if (cx == null || cx.lastInterpreterFrame == null) {
            ...
            ex.interpreterLineData = ((ACallFrame) cx.lastInterpreterFrame).getPcSourceLineStart();
        }
    }
    ...
    public String getSourcePositionFromStack(Context cx, int[] linep) {
        ACallFrame frame = (ACallFrame) cx.lastInterpreterFrame;
    ...
    public String getPatchedStack(RhinoException ex, String nativeStackTrace) {
        ...
        ACallFrame frame = (ACallFrame) ex.interpreterStackInfo;
        int offset = 0;
        while (frame != null) {
    ...
    public static Object resumeGenerator(
        ...
        CallFrame activeFrame = frame.shallowCloneFrozen((ACallFrame) cx.lastInterpreterFrame);
        try {
    ...
    private static CallFrame initFrame(
        ...
        CallFrame frame =
                new CallFrame(
                        ...
                        parentFrame,
                        parentFrame == null
                                ? (ACallFrame) cx.lastInterpreterFrame
