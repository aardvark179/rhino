...
public class EnumInitValuesInOrder extends Instruction {
    private final Operand obj;
    private final int index;

    public EnumInitValuesInOrder(Operand obj, int index) {
        this.obj = obj;
        this.index = index;
    }
    ...
    public void interpret(Context cx, CallFrameV2 frame) {
        ...
        frame.setLocal(
                ...
                ScriptRuntime.enumInit(
                        lhs, cx, frame.scope, ScriptRuntime.ENUMERATE_VALUES_IN_ORDER));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnumInitValuesInOrder)) {
            return false;
        }
        EnumInitValuesInOrder other = (EnumInitValuesInOrder) o;
