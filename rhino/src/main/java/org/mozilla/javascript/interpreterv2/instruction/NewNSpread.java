 ...
 * New3} instead.
 */
final class NewNSpread extends New {
    private final Operand[] arguments;

    NewNSpread(Operand fun, Operand[] arguments) {
        super(fun);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NewNSpread)) {
            return false;
        }
        NewNSpread other = (NewNSpread) o;
