...
public class Exponentiate extends Instruction {
    private final Operand lhs;
    private final Operand rhs;

    public Exponentiate(Operand lhs, Operand rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public void interpret(Context cx, CallFrameV2 frame) {
        ...
        var result = ScriptRuntime.exponentiate(lValue, rValue);
    ...
    public boolean equals(Object o) {
        ...
        Exponentiate other = (Exponentiate) o;
