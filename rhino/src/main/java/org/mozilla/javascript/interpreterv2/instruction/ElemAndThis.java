...
public class ElemAndThis extends Instruction {
    private final Operand obj;
    private final Operand id;

    public ElemAndThis(Operand obj, Operand id) {
        this.obj = obj;
        this.id = id;
    }
    ...
    public void interpret(Context cx, CallFrameV2 frame) {
        ...
        frame.push(ScriptRuntime.getElemAndThis(obj, id, cx, frame.scope));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ElemAndThis)) {
            return false;
        }
        ElemAndThis other = (ElemAndThis) o;
