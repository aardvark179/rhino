...
public class StrictSetName extends Instruction {
    private final Operand lhs;
    private final String name;
    private final Operand rhs;

    public StrictSetName(Operand lhs, String name, Operand rhs) {
        this.lhs = lhs;
        this.name = name;
        this.rhs = rhs;
    }
    ...
    public void interpret(Context cx, CallFrameV2 frame) {
        ...
        frame.push(ScriptRuntime.strictSetName(lhs, rhs, cx, frame.scope, name));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StrictSetName)) {
            return false;
        }
        StrictSetName other = (StrictSetName) o;
