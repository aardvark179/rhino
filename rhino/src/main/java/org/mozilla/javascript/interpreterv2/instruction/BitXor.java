...
public class BitXor extends Instruction {

    private final Operand lhs;
    private final Operand rhs;

    public BitXor(Operand lhs, Operand rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public void interpret(Context cx, CallFrameV2 frame) {
        ...
        if (rhs.isDouble(frame)) {
            ...
            if (lhs.isDouble(frame)) {
                ...
                int result = toInt32(l) ^ toInt32(r);
        ...
        var result = ScriptRuntime.bitwiseXOR(lValue, rValue);
