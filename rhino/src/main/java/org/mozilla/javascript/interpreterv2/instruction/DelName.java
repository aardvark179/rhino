...
public class DelName extends Instruction {
    private final Operand lhs;
    private final Operand rhs;

    public DelName(Operand lhs, Operand rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public void interpret(Context cx, CallFrameV2 frame) {
        ...
        frame.push(ScriptRuntime.delete(lhs, rhs, cx, frame.scope, true));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DelName)) {
            return false;
        }
        DelName other = (DelName) o;
