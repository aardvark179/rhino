...
public class ScriptNode extends Scope {
    ...
    protected void copyScriptNodeFieldsFrom(ScriptNode source) {
        ...
        if (source.regexps != null) {
            this.regexps = new ArrayList<>(source.regexps);
        }
        if (source.templateLiterals != null) {
            this.templateLiterals = new ArrayList<>(source.templateLiterals);
        }
