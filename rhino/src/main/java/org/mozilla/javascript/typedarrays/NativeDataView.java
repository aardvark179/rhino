...
public class NativeDataView extends NativeArrayBufferView {
    ...
    private static NativeDataView js_constructor(Context cx, JSScope scope, Object[] args) {
    ...
    private static Object js_getInt8(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        return realThis.js_getInt(cx, scope, 1, true, args);
    }

    private static Object js_getInt16(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        return realThis.js_getInt(cx, scope, 2, true, args);
    }

    private static Object js_getInt32(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        return realThis.js_getInt(cx, scope, 4, true, args);
    }

    private static Object js_getUint8(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        return realThis.js_getInt(cx, scope, 1, false, args);
    }

    private static Object js_getUint16(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        return realThis.js_getInt(cx, scope, 2, false, args);
    }

    private static Object js_getUint32(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        return realThis.js_getInt(cx, scope, 4, false, args);
    }

    private Object js_getInt(Context cx, JSScope scope, int bytes, boolean signed, Object[] args) {
    ...
    private static Object js_getFloat32(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        return realThis.js_getFloat(cx, scope, 4, args);
    }

    private static Object js_getFloat64(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        return realThis.js_getFloat(cx, scope, 8, args);
    }

    private Object js_getFloat(Context cx, JSScope scope, int bytes, Object[] args) {
        int pos = ScriptRuntime.toIndex(isArg(args, 0) ? args[0] : Undefined.instance);
    ...
    private static Object js_setInt8(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        realThis.js_setInt(cx, scope, 1, true, args);
        return Undefined.instance;
    }

    private static Object js_setInt16(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        realThis.js_setInt(cx, scope, 2, true, args);
        return Undefined.instance;
    }

    private static Object js_setInt32(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        realThis.js_setInt(cx, scope, 4, true, args);
        return Undefined.instance;
    }

    private static Object js_setUint8(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        realThis.js_setInt(cx, scope, 1, false, args);
        return Undefined.instance;
    }

    private static Object js_setUint16(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        realThis.js_setInt(cx, scope, 2, false, args);
        return Undefined.instance;
    }

    private static Object js_setUint32(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        realThis.js_setInt(cx, scope, 4, false, args);
        return Undefined.instance;
    }

    private void js_setInt(Context cx, JSScope scope, int bytes, boolean signed, Object[] args) {
        int pos = ScriptRuntime.toIndex(isArg(args, 0) ? args[0] : Undefined.instance);
    ...
    private static Object js_setFloat32(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        realThis.js_setFloat(cx, scope, 4, args);
        return Undefined.instance;
    }

    private static Object js_setFloat64(Context cx, JSScope scope, Object thisObj, Object[] args) {
        NativeDataView realThis = realThis(thisObj);
        realThis.js_setFloat(cx, scope, 8, args);
        return Undefined.instance;
    }

    private void js_setFloat(Context cx, JSScope scope, int bytes, Object[] args) {
        int pos = ScriptRuntime.toIndex(isArg(args, 0) ? args[0] : Undefined.instance);
