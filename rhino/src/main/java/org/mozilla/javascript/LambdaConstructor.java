...
public class LambdaConstructor extends LambdaFunction {
    ...
    public Scriptable construct(Context cx, JSScope scope, Object target, Object[] args) {
        ...
        return fireConstructor(cx, getDeclarationScope(), target, args);
    }
     ...
     */
    public void definePrototypeMethod(
            JSScope scope, SymbolKey name, int length, SerializableCallable target) {
        definePrototypeMethod(scope, name, length, target, DONTENUM, DONTENUM | READONLY);
    }
     ...
     */
    public void defineConstructorMethod(
            JSScope scope, Symbol key, String name, int length, SerializableCallable target) {
