...
public abstract class XMLObject extends IdScriptableObject {
     ...
     * search. Return null if no such object available.
     */
     ...
     * @param thisIsLeft if true, the object should calculate this + value if false, the object
     *     should calculate value + this.
