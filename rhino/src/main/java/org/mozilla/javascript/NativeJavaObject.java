...
public class NativeJavaObject implements Scriptable, SymbolScriptable, Wrapper, Serializable {
    ...
    public NativeJavaObject(JSScope scope, Object javaObject, TypeInfo staticType) {
        this(scope, javaObject, staticType, false);
    }

    public NativeJavaObject(
            JSScope scope, Object javaObject, TypeInfo staticType, boolean isAdapter) {
        this.parent = scope;
        ...
        if (hint == null || hint == ScriptRuntime.StringClass) {
            ...
            if (converterObject instanceof Function) {
                ...
                value =
                        f.call(
                                Context.getContext(),
                                (Scriptable) f.getDeclarationScope(),
                                this,
