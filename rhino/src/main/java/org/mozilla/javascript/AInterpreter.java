...
public abstract class AInterpreter<T extends ACallFrame<T, U>, U extends ACompilerData<?, U>> implements Evaluator {

    protected static final class ContinuationJump<T extends ACallFrame<T, U>, U extends ACompilerData<?, U>>  implements Serializable {
    ...
    static <T extends ACallFrame<T, U>, U extends ACompilerData<?, U>> void exitFrame(Context cx, T frame, Object throwable) {
