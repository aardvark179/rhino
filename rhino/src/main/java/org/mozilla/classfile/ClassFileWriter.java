...
public class ClassFileWriter {
    ...
    public void stopMethod(int maxLocals) {
        ...
        if (attrLength > 65536) {
            ...
            throw new ClassSizeException("generated bytecode for method exceeds 64K limit.");
        }
    ...
    public void add(int theOpCode, int theOperand) {
        ...
        switch (theOpCode) {
            ...
            case ByteCode.LDC2_W:
                if (theOperand < 0) {
                    throw new ClassFileFormatException("negative operand");
                } else if (theOperand > 0xffff) {
                    throw new ClassSizeException("operand too large");
                }
                if (theOperand >= 256
    ...
    private void fixLabelGotos() {
        ...
        for (int i = 0; i < itsFixupTableTop; i++) {
            ...
            if ((short) offset != offset) {
                throw new ClassSizeException("Program too complex: too big jump offset");
            }
